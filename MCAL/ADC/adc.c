...
static inline void adc_input_channel_port_configure(adc_channel_select_t channel){
    switch(channel){
        case ADC_CHANNEL_AN0 : bit_set(TRISA, _TRISA_RA0_POSN); break; 
        case ADC_CHANNEL_AN1 : bit_set(TRISA, _TRISA_RA1_POSN); break; 
        case ADC_CHANNEL_AN2 : bit_set(TRISA, _TRISA_RA2_POSN); break; 
        case ADC_CHANNEL_AN3 : bit_set(TRISA, _TRISA_RA3_POSN); break; 
        case ADC_CHANNEL_AN4 : bit_set(TRISA, _TRISA_RA5_POSN); break; 
        case ADC_CHANNEL_AN5 : bit_set(TRISE, _TRISE_RE0_POSN); break; 
        case ADC_CHANNEL_AN6 : bit_set(TRISE, _TRISE_RE1_POSN); break; 
        case ADC_CHANNEL_AN7 : bit_set(TRISE, _TRISE_RE2_POSN); break; 
        case ADC_CHANNEL_AN8 : bit_set(TRISB, _TRISB_RB2_POSN); break; 
        case ADC_CHANNEL_AN9 : bit_set(TRISB, _TRISB_RB3_POSN); break; 
        case ADC_CHANNEL_AN10 : bit_set(TRISB, _TRISB_RB1_POSN); break; 
        case ADC_CHANNEL_AN11 : bit_set(TRISB, _TRISB_RB4_POSN); break; 
        case ADC_CHANNEL_AN12 : bit_set(TRISB, _TRISB_RB0_POSN); break;
        default : /* Nothing */;
    }
}
